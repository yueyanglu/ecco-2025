...
#SBATCH -o ECCOv4r5-%j-out
#SBATCH -e ECCOv4r5-%j-out
...
nprocs=113
basedir="/efs_ecco/$USER/r5/WORKINGDIR/ECCOV4/release5/"
inputdir=../../../../input/
...
# 3-month run (1/1992–3/1992). For 28 years (1992–2019), comment out the next 3 lines.
unlink data
cp -p ../namelist/data .
